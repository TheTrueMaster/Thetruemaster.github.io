    ...
    <div class="welcome-text">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <h1 style="font-family:Lato">Future Doctors of Westview</h1>
                <h2>inspiring a new generation of doctors</h2>
            </div>
...
<div class="our-mission">
    ...
    <div class="row" style="padding-top: 20px; padding-bottom:20px;" >
        ...
        <div class="col-md-6">
            <h3 style="color:#800080">Future Doctors of Westview is a club that is dedicated to inspiring and helping students at <a href="http://www2.powayusd.com/pusdwvhs/">Westview High School</a> to becom doctors. We hold fundraisers and host guest speakers, as well as volunteer in our community. </p>
            <p>
